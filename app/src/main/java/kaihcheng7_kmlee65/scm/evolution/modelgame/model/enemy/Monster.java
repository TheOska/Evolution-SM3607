...
public class Monster extends Enemy {
    ...
    public Monster(Context context, ImageView ivEnemy, Drawable enemyDrawable, int hp, String name, int craftLevel) {
        super(context);
        setEnemyDrawable(enemyDrawable);
        setEnemyHP(hp);
        setEnemyName(name);
        setIvEnemy(ivEnemy);
        setCraftLevel(craftLevel);
    }
    public Monster(Context context, ImageView ivEnemy, String enemyImageName, int hp, String name, int craftLevel, int position) {
        super(context);
